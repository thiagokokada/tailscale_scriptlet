...
BUILD_DIR="$ROOT/build/tailscale-standalone-v$VERSION"
ARCHIVE="$ROOT/build/kterm-kindle-2.6.zip"
OUTPUT="$ROOT/build/tailscale-standalone-v$VERSION.zip"
...
cp "$ROOT/standalone/bin/menu.sh" "$BUILD_DIR/extensions/tailscale-menu.sh"
cp "$ROOT/standalone/documents/Tailscale.sh" "$BUILD_DIR/documents/Tailscale.sh"
